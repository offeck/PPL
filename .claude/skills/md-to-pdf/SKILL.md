...
```bash
python3 .claude/skills/md-to-pdf/convert.py input.md output.pdf
```
...
python3 .claude/skills/md-to-pdf/convert.py lecture.md lecture.pdf

# English report, US Letter, larger font
python3 .claude/skills/md-to-pdf/convert.py report.md report.pdf --page-size LETTER --font-size 12

# Force LTR even if RTL characters are present
python3 .claude/skills/md-to-pdf/convert.py mixed.md mixed.pdf --no-bidi
```
