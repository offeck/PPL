...
const L3_eval_env_1 = require("../L3/L3-eval-env");
const L3_value_1 = require("../L3/L3-value");
const result_1 = require("../shared/result");
const L3_ast_1 = require("../L3/L3-ast");
const evalP = (x) => (0, result_1.bind)((0, L3_ast_1.parseL3)(x), L3_eval_env_1.evalL3program);
const evalP2String = (x) => {
    const res = (0, result_1.bind)((0, L3_ast_1.parseL3)(x), L3_eval_env_1.evalL3program);
